...
const publicPaths = ['index.html','now.html','404.html','blog','projects','styles.css','site.js',
  'favicon.svg','favicon-32x32.png','apple-touch-icon.png','og-image.png','assets','resume.pdf','robots.txt','sitemap.xml','feed.xml','CNAME'];
